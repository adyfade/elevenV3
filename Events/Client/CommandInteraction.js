            ...
            if (command.player) {
                ...
                if (command.player.voice) {
                    if (!interaction.member.voice.channel) {
                        ...
                        return await interaction.reply({ content: `> <:11:1288062188854050887> **You must be connected to a voice channel to use this \`${command.name}\` command.**`, ephemeral: true });
                    }
